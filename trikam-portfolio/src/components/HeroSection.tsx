...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[min(100vh,820px)] flex items-center pt-24 pb-12 sm:pt-28 sm:pb-16 px-6 md:px-12">
      <div className="w-full max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 items-center gap-10 lg:gap-14">
          ...
          <div className="flex flex-col items-start text-left md:col-span-7">
            ...
            <div className="flex items-center gap-2 mb-3 text-muted-foreground">
              ...
              <span className="text-[11px] font-mono tracking-wider uppercase">
                TRIKAM.DEVASI // FULL-STACK · AI · REAL-TIME
              </span>
            </div>
            ...
            <p className="text-base text-muted-foreground leading-relaxed mb-4 max-w-xl">
              ...
              AI-integrated products with modern architecture and high craft.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-x-3 gap-y-2 text-xs text-muted-foreground pt-4 border-t border-border/50 w-full max-w-xl">
          ...
          <div className="flex flex-col items-center md:items-end justify-center md:col-span-5">
            <div className="relative w-56 h-56 sm:w-64 sm:h-64 lg:w-72 lg:h-72 xl:w-80 xl:h-80 rounded-2xl overflow-hidden border border-border bg-surface shadow-sm">
              <img
            ...
            <div className="mt-2.5 flex items-center justify-between text-[11px] font-mono text-muted-foreground w-56 sm:w-64 lg:w-72 xl:w-80 px-1">
              <span>SWAMINARAYAN UNIV.</span>
